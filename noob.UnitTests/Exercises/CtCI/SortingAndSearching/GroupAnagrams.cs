...
public class GroupAnagrams
{
    ...
    [Theory]
    [InlineData([new string[] { "evil", "meow", "vile", "moo" }, new string[] { "evil", "vile", "moo", "meow" }])]
    [InlineData([new string[] { "evil", "meow", "vile", "moo", "restful", "fluster", "hurt" }, new string[] { "evil", "vile", "fluster", "restful", "moo", "hurt", "meow" }])]
    [InlineData([new string[] { "evil", "meow", "vile", "moo", "live" }, new string[] { "evil", "live", "vile", "moo", "meow" }])]
